...
Route::group(['middleware' => 'language'], function () {
    ...
    */
    Route::group(['middleware' => ['auth', 'twostep', 'banned']], function () {
        ...
        // Donation System
        Route::get('/donation/add', 'DonationsController@index')->name('add_donation_form');
        Route::post('/donation/add', 'DonationsController@store')->name('add_donation');
    });
    ...
    */
    Route::group(['prefix' => 'staff_dashboard', 'middleware' => ['auth', 'twostep', 'modo', 'banned'], 'namespace' => 'Staff'], function () {
        ...
        // Donations
        Route::get('/donations', 'DonationsController@index')->name('staff_donation_index');
        Route::get('/donation/add', 'DonationsController@create')->name('staff_donation_add_form');
        Route::post('/donation/add', 'DonationsController@store')->name('staff_donation_add');
        Route::get('/donation/reverse/{id}', 'DonationsController@reverseForm')->name('staff_donation_reverse_form');
        Route::post('/donation/reverse/{id}', 'DonationsController@reverse')->name('staff_donation_reverse');
        Route::get('/donation/approve/{id}', 'DonationsController@approveForm')->name('staff_donation_approve_form');
        Route::post('/donation/approve/{id}', 'DonationsController@approve')->name('staff_donation_approve');
        Route::get('/donation/reject/{id}', 'DonationsController@rejectForm')->name('staff_donation_reject_form');
        Route::post('/donation/reject/{id}', 'DonationsController@reject')->name('staff_donation_reject');

        // Packages
        Route::get('/packages', 'PackagesController@index')->name('staff_package_index');
        Route::get('/package/add', 'PackagesController@addForm')->name('staff_package_add_form');
        Route::post('/package/add', 'PackagesController@add')->name('staff_package_add');
        Route::get('/package/edit/{id}', 'PackagesController@editForm')->name('staff_package_edit_form');
        Route::post('/package/edit/{id}', 'PackagesController@edit')->name('staff_package_edit');
        Route::get('/package/delete/{id}', 'PackagesController@deleteForm')->name('staff_package_delete_form');
        Route::post('/package/delete/{id}', 'PackagesController@delete')->name('staff_package_delete');

        // Packages
        Route::get('/gateways', 'GatewaysController@index')->name('staff_gateway_index');
        Route::get('/gateway/add', 'GatewaysController@addForm')->name('staff_gateway_add_form');
        Route::post('/gateway/add', 'GatewaysController@add')->name('staff_gateway_add');
        Route::get('/gateway/edit/{id}', 'GatewaysController@editForm')->name('staff_gateway_edit_form');
        Route::post('/gateway/edit/{id}', 'GatewaysController@edit')->name('staff_gateway_edit');
        Route::get('/gateway/delete/{id}', 'GatewaysController@deleteForm')->name('staff_gateway_delete_form');
        Route::post('/gateway/delete/{id}', 'GatewaysController@delete')->name('staff_gateway_delete');
    });
});
