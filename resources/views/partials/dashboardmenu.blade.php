<div class="col-sm-2 col-lg-2">
    <div class="block">
        <ul class="nav nav-list">
            ...
            @if (auth()->user()->group->is_owner)
                <li class="nav-header head">
                    <i class="{{ config('other.font-awesome') }} fa-wrench"></i> Donation Tools
                </li>
                <li>
                    <a href="{{ route('staff_donation_index') }}">
                        <i class="{{ config('other.font-awesome') }} fa-heart"></i> Donations
                        <span class="badge badge-danger"> {{ $donor_count }} </span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('staff_package_index') }}">
                        <i class="{{ config('other.font-awesome') }} fa-dollar-sign"></i> Packages
                    </a>
                </li>
                <li>
                    <a href="#">
                        <i class="fab fa-bitcoin"></i> Gateways
                    </a>
                </li>
            @endif
